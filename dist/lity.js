/*! XHTML Lity - v1.0.3 - 2017-09-10
* Copyright (c) 2016 Lynx Kotoura and Copyright (c) 2016 Jan Sorgalla; Licensed MIT */
(function(window, factory) {
    ...
    var _defaultOptions = {
        esc: true,
        handler: null,
        template: '<div class="lity" tabindex="-1"><div class="lity-wrap data-lity-close"><div class="lity-loader">Loading...</div><div class="lity-container"><div class="lity-content"></div><button class="lity-close data-lity-close" type="button" title="Close (Esc)">×</button></div></div></div>'
    };
        ...
        function init(handler, content, options, el) {
            ...
            setTimeout(function() {
                _instance
                    ...
                    .on('click', '[class~='data-lity-close']', function(e) {
                        if ($(e.target).is('[class~='data-lity-close']')) {
                            close();
                        }
                    })
    ...
    $(document).on('click', '[class~='data-lity']', lity());
